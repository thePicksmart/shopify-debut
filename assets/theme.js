...
//     var $myFixed = $('#shopify-section-header');
//     var translateHeaderHeight = $myFixed.css('position') == "fixed" 
//         ? $myFixed.outerHeight() 
...
// =============== custom js by bingqian ==============

let checkCurrencySwitcher = setInterval(function () {
  if($('.doubly-wrapper').length) {
    $('.doubly-wrapper').css('margin', '0')
    $('.doubly-wrapper').css('margin-top', '2px')
    $('.doubly-wrapper').addClass('custom-currency-wrapper')
    $('select.currency-switcher').addClass('currency-add-on')
    if (window.location.href == 'https://thepicksmart.com/') {
      $('.doubly-wrapper select').addClass('custom-currency-wrapper-text')
      $(window).bind('scroll', function() {
        var distance = 5;
        if ($(window).scrollTop() > distance) {
          $('.doubly-wrapper select').removeClass('custom-currency-wrapper-text')
        }
        else {
          $('.doubly-wrapper select').addClass('custom-currency-wrapper-text')
        }
